...
The [Maven Archetype Plugin](https://maven.apache.org/archetype/maven-archetype-plugin/) (at least in its version `3.2.1`) loads, by default, a big remote catalog (useless en thid case). You can set the **archetypeCatalog** property with the value **internal** to avoid it
