...
This repository was created to contain the source code and artifacts of all the [Maven archetypes](https://maven.apache.org/guides/introduction/introduction-to-archetypes.html) needed by any Softalks solution
## Archetype selection
...
The [Maven Archetype Plugin](https://maven.apache.org/archetype/maven-archetype-plugin/) (at least in version `3.2.1`) loads a huge and useless, in this case, list of archetypes at [project generation](https://maven.apache.org/archetype/maven-archetype-plugin/generate-mojo.html) time. You can set the **archetypeCatalog** property with the value **internal** to avoid it
