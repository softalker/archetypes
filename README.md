...
The [Maven Archetype Plugin](https://maven.apache.org/archetype/maven-archetype-plugin/) (at least in version `3.2.1`) loads by default a big and useless, in this case, list of archetypes at [project generation](https://maven.apache.org/archetype/maven-archetype-plugin/generate-mojo.html) time. You can set the **archetypeCatalog** property with the value **internal** to avoid it
