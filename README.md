...
The [Maven Archetype Plugin](https://maven.apache.org/archetype/maven-archetype-plugin/) (at least in version `3.2.1`) loads, by default, a big remote catalog (useless en this case) when invoking the `archetype:generate` goal. You can set the **archetypeCatalog** property with the value **internal** to avoid it
