...
```
> If you choose not to use this file you must put this same content on the command line when invoking the `archetype:generate` goal (alongside all other properties)
